...
\setthesisscope
  {80}% Total pages (count final PDF)
  {07}% Total tables (count from List of Tables)
  {05}% Total figures (count from List of Figures)
  ...
  {30}% Total references (count bibliography entries)
